...
get-latest-hcs-ama-api-spec-swagger:
	curl https://raw.githubusercontent.com/hashicorp/cloud-consul-ama-api-spec/master/hcs/swagger.json --output ./internal/clients/hcs-ama-api-spec/swagger/hcs-swagger.json
...
generate-hcs-ama-api-spec-models: get-latest-hcs-ama-api-spec-swagger
	swagger generate model \
		--spec=./internal/clients/hcs-ama-api-spec/swagger/hcs-swagger.json \
		--target=./internal/clients/hcs-ama-api-spec \
		--skip-validation
